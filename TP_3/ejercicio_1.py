...
restriction_functions = [
    lambda a, b, c, d: a >= 0 and b >= 0 and c >= 0 and d >= 0,
    lambda a, b, c, d: 2.5 * a + 1.5 * b + 2.75 * c + 2.0 * d <= 640,
    lambda a, b, c, d: 3.5 * a + 3.0 * b + 3.0 * c + 2.0 * d <= 960
]
verbose = False
...
'''
La solución óptima es Z = 113600
X1 = 0
X2 = 192
X3 = 128
X4 = 0
